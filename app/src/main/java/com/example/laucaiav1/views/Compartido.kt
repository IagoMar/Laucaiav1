...
@Composable
fun PantallaCompartido(modifier: Modifier = Modifier) {
    ConstraintLayout(
        modifier
            .fillMaxSize()
            .background(
...

    {
        ...
        Text("COMPARTIDO", fontFamily = FontFamily(Font(com.example.laucaiav1.R.font.mi_fuente)),  modifier = modifier.constrainAs(texto){
